...
local user_opts = {
    ...
    keybindings = no,             -- register keybindings i.e. chapter scrubbing, pinning window
    ...
    thumbnailborder = 0,            -- the width of the thumbnail border
    ...
    showtitle = flase,               -- show title in OSC
    ...
    -- seekbar settings --
    seekbarfg_color = '9A68FF',     -- color of the seekbar progress and handle, in format BBGGRR - http://www.tcax.org/docs/ass-specs.htm
    ...
    timefontsize = 22,                         -- the font size of the time
    ...
    volumecontrol = false,           -- whether to show mute button and volume slider
